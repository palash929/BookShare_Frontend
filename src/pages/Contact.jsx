...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const SERVICE_ID = "service_dds1bin";
    const TEMPLATE_ID = "template_cc372f9";
    const PUBLIC_KEY = "Yzp5QHuTWTaazGiD1";
    ...
    <div className="bg-gray-50 min-h-screen py-16 flex items-center">
      <div className="max-w-2xl mx-auto px-6 w-full bg-white rounded-2xl shadow-2xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-yellow-400 text-black font-semibold py-3 rounded-2xl hover:bg-yellow-300 transition cursor-pointer"
          >
            Send Message
          </button>
        </form>
